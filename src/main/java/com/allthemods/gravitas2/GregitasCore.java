...
public class GregitasCore {
    ...
    public static void registerTFCAmbientalBlocks() {
        ...
        AmbientalRegistry.BLOCKS.register((player, blockPos, state) -> Optional.of(new TempModifier("tungstensteel_coil", 45.0F, 3.0F)).filter((mod) -> state.getBlock() == GTBlocks.COIL_RTMALLOY.get() && state.getValue(ActiveBlock.ACTIVE)));
